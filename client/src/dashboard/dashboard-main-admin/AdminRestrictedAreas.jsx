...
import { FiPlus, FiTrash2, FiX, FiCheck, FiMapPin, FiEye, FiEyeOff } from 'react-icons/fi';
import { restrictedAreasService } from '../../services/restrictedAreasService';
import toast from 'react-hot-toast';

const AdminRestrictedAreas = () => {
  ...
  // Load restricted areas on mount
  useEffect(() => {
    loadRestrictedAreas();
  ...
  const handleSaveArea = async () => {
    ...
    try {
      ...
      if (formData.type === 'circle') {
        ...
        // Polygon - create a square around the center point
...
export default AdminRestrictedAreas;
